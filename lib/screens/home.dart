...
import 'package:getx_internationalization/screens/stepperPage.dart';
...
class _HomeState extends State<Home> {
  ...
  List<Step> steps = [
    Step(
      ...
      content: Container(
          alignment: Alignment.centerLeft, child: Text('Content for Step 1')),
    ),
    Step(
      title: Text('Services'),
      content: Container(
